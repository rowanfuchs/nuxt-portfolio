<template>
    <div class="timeline mt-6">
        <div
            ...
            <div
                :class="
                    index % 2 === 0 ? 'timeline-post-marker' : 'timeline-post-marker -left-2'
                " />
            <div class="timeline-card" :class="project.cancelled ? 'timeline-cancelled' : ''">
                <span class="timeline-date">
                    {{ project.date }}
                </span>
                <span class="float-right cursor-pointer" @click="openImageModal(project.index)">
            ...
            <div
                ...
                <div class="timeline-modal-card">
                    ...
                    <button
                        ...
                        @click="closeImageModal(project.index)">
                        <svg
    ...
    data() {
        return {
            ...
            types: {
                ...
                laravel:
                    'text-red-700 bg-red-100 border-red-300 dark:text-red-100 dark:bg-red-700 dark:border-red-900',
                docker: 'text-indigo-700 bg-indigo-100 border-indigo-300 dark:text-indigo-100 dark:bg-indigo-700 dark:border-indigo-900',
                tailwind:
                    'text-blue-700 bg-blue-100 border-blue-300 dark:text-blue-100 dark:bg-blue-700 dark:border-blue-900',
                ...
                codeigniter:
                    'text-red-700 bg-red-100 border-red-300 dark:text-red-100 dark:bg-red-700 dark:border-red-900',
                graphql:
                    'text-pink-700 bg-pink-100 border-pink-300 dark:text-pink-100 dark:bg-pink-700 dark:border-pink-900'
            }
        }
    },
    methods: {
