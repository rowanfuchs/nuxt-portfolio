<template>
    <div>
        <section class="relative block h-96 md:h-120">
            ...
            <div
                class="top-auto bottom-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden h-96">
                <svg
        ...
        <section class="relative py-16">
            <div class="container mx-auto px-4">
                <div class="bg-white w-full mb-6 shadow-xl rounded-lg -mt-64 dark:bg-gray-800">
                    <div class="px-6">
                        <div class="flex flex-wrap justify-center">
                            <div class="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                                <div class="relative">
                                    <img
                                        alt="An image of Rowan Fuchs"
                            ...
                            <div
                                ...
                                <div
                                    class="flex justify-center md:justify-end py-6 px-3 mt-6 md:mt-0">
                                    <button
                                        class="contact-button"
                                        type="button"
                                        @click="open('https://linkedin.com/in/rowanfuchs/')">
                                        Connect
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="text-center mt-6 md:mt-12">
                            <h3
                                class="text-4xl font-semibold leading-normal mb-2 text-gray-700 dark:text-gray-200 mb-2">
                                Rowan
                                <span class="hidden md:inline-block">Ryuichi</span>
                                Fuchs
                            </h3>
                            <div
                        ...
                        <div
                            class="mt-10 py-10 border-t border-gray-300 dark:border-gray-700 text-center">
                            <div class="flex flex-wrap justify-center">
                                <div class="w-full lg:w-9/12 px-4">
                                    <p
                                        class="text-lg leading-relaxed text-gray-700 dark:text-gray-200">
                                        I am an enthusiastic, creative and ambitious person who is
                                        always willing to learn and broaden my experience. I'm
                                        always looking for a challenge and adapt easily to new
                                        environments. I enjoy working independently while also
                                        thrive when working in a team.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="w-full mb-6">
                    <div class="mt-10 py-10 text-center">
                        <div class="text-center">
                            <h3
                                class="text-4xl font-semibold leading-normal mb-2 text-gray-700 dark:text-gray-400 mb-2">
                                Portfolio
                            </h3>
                        </div>
                        <div class="flex flex-wrap justify-center">
...
export default {
    name: 'IndexPage',
    components: { CareerTimeline, SkillStack },
    data() {
        return {
            displayImages: true,
            backgroundImage,
